...
3. [Syntax Overview](#syntax-overview)
   1. [Class Structure](#class-structure)
      ...
      6. [ToString](#tostring)
      7. [Example 1: Class Structure](#example-1-class-structure)
   2. [Creating instances of a class](#creating-instances-of-a-class)
   3. [Static vs. Instance](#static-vs-instance)
      1. [Static](#static)
      2. [Instance](#instance)
   4. [Accessors/Mutators aka Getter/Setter](#accessorsmutators-aka-gettersetter)
   5. [Overloaded Methods](#overloaded-methods)
   6. [Inheritance](#inheritance)
   7. [Using the Base Constructor](#using-the-base-constructor)
...
4. [Design Patterns](#design-patterns)
   ...
   4. [Factory Pattern](#factory-pattern)
      1. [Standard Factory Object Generation](#standard-factory-object-generation)
      2. [Using Static Methods to Set/Fetch Objects](#using-static-methods-to-setfetch-objects)
   5. [Method Chaining](#method-chaining)
   6. [Base Splat Pattern](#base-splat-pattern)
      1. [Using object properties to Splat a function](#using-object-properties-to-splat-a-function)
      2. [Using Base Helper to Generate Splat HashTable](#using-base-helper-to-generate-splat-hashtable)
   7. [Loading Class Files](#loading-class-files)
      1. [Possible Workarounds](#possible-workarounds)
...
[9]: #constructor
[10]: #tostring
[11]: #example-1-class-structure
[12]: #creating-instances-of-a-class
[13]: #static-vs-instance
[14]: #static
[15]: #instance
[16]: #accessorsmutators-aka-gettersetter
[17]: #overloaded-methods
[18]: #inheritance
[19]: #using-the-base-constructor
[20]: #enumerations
[21]: #design-patterns
[22]: #polymorphism
[23]: #abstract-classes
[24]: #singleton
[25]: #factory-pattern
[26]: #standard-factory-object-generation
[27]: #using-static-methods-to-setfetch-objects
[28]: #method-chaining
[29]: #base-splat-pattern
[30]: #using-object-properties-to-splat-a-function
[31]: #using-base-helper-to-generate-splat-hashtable
[32]: #loading-class-files
